...
describe( 'getFormatProperties', () => {
	...
	test( 'should return an object of value, target, and node for a link', () => {
		const mockNode = {
			...node,
	...
	test( 'should return an object of value, target, and node of empty values when no values are found.', () => {
		const mockNode = {
			...node,
			attributes: {},
			getAttribute: jest.fn().mockImplementation( ( attr ) => mockNode.attributes[ attr ] ),
