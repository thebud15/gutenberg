...
describe( 'selectors', () => {
	...
	describe( 'isBlockInsertionPointVisible', () => {
		it( 'should return true if an index is assigned', () => {
			const state = {
				blockInsertionPoint: {
					index: 5,
				},
		...
		it( 'should return false if an index is not assigned', () => {
			// TODO
		} );

		it( 'should return false if an index is assigned, but not within specified layout', () => {
			// TODO
		} );

		it( 'should return true if an index is assigned and within specified layout', () => {
			// TODO
		} );
	} );
